...
main(int argc, char *argv[])
{
  ...
  47:	e8 13 03 00 00       	call   35f <unlink>
  ...
  66:	c7 44 24 04 96 0e 00 	movl   $0xe96,0x4(%esp)
  6d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 428:	0f b6 80 30 13 00 00 	movzbl 0x1330(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
 ...
 585:	75 09                	jne    590 <printf+0x101>
          s = "(null)";
 587:	c7 45 f4 af 0e 00 00 	movl   $0xeaf,-0xc(%ebp)
        while(*s != 0){
...
void uthread_sleep(void)
{
 ...
 c45:	c7 44 24 04 b6 0e 00 	movl   $0xeb6,0x4(%esp)
 c4c:	00 
...
void printQueue(struct binary_semaphore* semaphore)
{
 ...
 cce:	c7 44 24 04 d1 0e 00 	movl   $0xed1,0x4(%esp)
 cd5:	00 
 ...
 cf9:	c7 44 24 04 e8 0e 00 	movl   $0xee8,0x4(%esp)
 d00:	00 
...
void printQueue(struct binary_semaphore* semaphore)
{
 ...
 d15:	7e d4                	jle    ceb <printQueue+0x23>
	...
	printf(1,"\n*** WAITING QUEUE ***\n");	
 d17:	c7 44 24 04 ec 0e 00 	movl   $0xeec,0x4(%esp)
 d1e:	00 
